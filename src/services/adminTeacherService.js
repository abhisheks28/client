...
export const getTeacherDetails = async (teacherUid) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}`);
        if (response.ok) {
            return await response.json();
        }
        return null;
...
export const assignGradesToTeacher = async (teacherUid, grades, adminUid) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}/grades`, {
            method: 'POST',
...
export const assignStudentsToTeacher = async (teacherUid, students, adminUid) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}/students`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
export const removeGradeFromTeacher = async (teacherUid, grade) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}/grades/${encodeURIComponent(grade)}`, {
            method: 'DELETE'
        });
        return response.ok;
    } catch (error) {
...
export const removeStudentFromTeacher = async (teacherUid, studentUid) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}/students/${studentUid}`, {
            method: 'DELETE'
        });
        return response.ok;
    } catch (error) {
...
export const resetTeacherAssignments = async (teacherUid, adminUid) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}/reset`, {
            method: 'POST'
        });
        return response.ok;
    } catch (error) {
...
export const updateTeacherPermissions = async (teacherUid, permissions, adminUid) => {
    try {
        const response = await fetch(`/api/v1/teachers/${teacherUid}/permissions`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
...
export const getStudentsByGrade = async (grade) => {
    try {
        ...
        const response = await fetch(`/api/v1/teachers/students/available?grade=${encodeURIComponent(grade)}`);
...
export const deleteTeacher = async (teacherUid) => {
    try {
        const response = await fetch(`/api/v1/users/${teacherUid}`, {
            method: 'DELETE'
        });
        return response.ok;
    } catch (error) {
