    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            const payload = {
                ...
                user_type: registrationType // 'parent', 'student', 'teacher', 'guest'
            };
            ...
            const firebasePayload = {
                ...
                email: data.email,
                firstName: data.name, // Backend expects firstName
                user_id: createdUserUid, // Backend expects user_id
                ticketCode: newCode,
                // Optional fields
                grade: registrationType === 'student' ? data.studentGrade : (data.students?.[0]?.grade || ""),
                schoolName: data.schoolName || (data.students?.[0]?.school || ""),
                profession: data.profession,
                referenceSource: "Lottery", // Default
            };

            try {
                const apiResponse = await fetch('/api/v1/lottery/register', {
                    method: 'POST',
