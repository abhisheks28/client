    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Fetch Stats
                const statsRes = await fetch('/api/v1/dashboard/admin/stats');
                if (statsRes.ok) {
                ...
                // Fetch Charts
                const chartsRes = await fetch('/api/v1/dashboard/admin/charts');
                if (chartsRes.ok) {
                ...
                // Fetch Students
                const studentsRes = await fetch('/api/v1/dashboard/admin/students?limit=200');
                if (studentsRes.ok) {
            ...
            {view === 'overview' ? (
                <>
                    ...
                    <Grid container spacing={3}>
                        <Grid size={{ xs: 12, md: 6 }} sx={{ minHeight: 350 }}>
